...
public class userTweetDriver extends Configured implements Tool{
	...
	public int run (String[] args)  throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setJarByClass(userTweetDriver.class);
	...
	public static void main(String[] args) throws Exception {
		int exit = ToolRunner.run (new Configuration(), new userTweetDriver(),args);
		System.exit (exit);
	} 
